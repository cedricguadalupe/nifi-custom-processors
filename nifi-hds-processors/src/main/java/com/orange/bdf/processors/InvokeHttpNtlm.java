...
import com.orange.bdf.processors.utils.NTLMAuthenticator;
...
public final class InvokeHttpNtlm extends AbstractProcessor {
    ...
    public static final PropertyDescriptor PROP_DOMAIN = new PropertyDescriptor.Builder()
            .name("Domain")
            .displayName("Domain")
    ...
    public static final PropertyDescriptor PROP_DOMAIN_USERNAME = new PropertyDescriptor.Builder()
    ...
    public static final PropertyDescriptor PROP_DOMAIN_PASSWORD = new PropertyDescriptor.Builder()
            .name("Domain Username Password")
            .displayName("Domain Username Password")
    ...
    public static final List<PropertyDescriptor> PROPERTIES = Collections.unmodifiableList(Arrays.asList(
            ...
            PROP_DOMAIN,
            PROP_DOMAIN_USERNAME,
            PROP_DOMAIN_PASSWORD,
            PROP_PROXY_HOST,
            PROP_PROXY_PORT,
            PROP_PROXY_USER,
            PROP_PROXY_PASSWORD,
    ...
    private void setAuthenticator(OkHttpClient.Builder okHttpClientBuilder, ProcessContext context) {
        ...
        final String domainUsername = context.getProperty(PROP_DOMAIN_USERNAME).getValue();
        final String passwordUsername = context.getProperty(PROP_DOMAIN_PASSWORD).getValue();
        final String activeDirectoryDomain = context.getProperty(PROP_DOMAIN).getValue();
        okHttpClientBuilder.authenticator(new NTLMAuthenticator(domainUsername, passwordUsername, activeDirectoryDomain));
    }
