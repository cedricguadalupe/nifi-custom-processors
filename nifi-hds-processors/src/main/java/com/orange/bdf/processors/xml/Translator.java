...
import com.orange.bdf.processors.json.*;
...
public class Translator
{
      ...
      if (lType instanceof XSComplexTypeDecl)
      {
        ...
        if (lParticle != null)
        {
          ...
          if (lTerm instanceof XSModelGroup)
          {
            ...
            {
              XSParticle lSubParticle = (XSParticle)lParticles.item(0);
                                              ...
                                              XSParticle xiParticle)
  {
    ...
    if (lTerm instanceof XSModelGroup)
    {
      ...
      XSObjectList lParticles = ((XSModelGroup)lTerm).getParticles();
      lMulti = null;
      Object lParticleObj = null;
      for (int i = 0; i < lParticles.getLength(); i++)
      {
        lParticleObj = lParticles.item(i);
